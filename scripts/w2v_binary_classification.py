...
def main():
    ...
    # Prepare dataset
    X, y, filenames = classifier.prepare_dataset_cached(clean_paths, clean_labels, target_error_category='Correct', max_length=10, features_save_path='audio_features.pkl')
    
    # Train models
    results = classifier.train(X, y)
    
    # Save model
    classifier.save_model('audio_classifier_model.pkl')
